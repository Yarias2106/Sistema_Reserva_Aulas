"""
Django settings for Proyecto_Munay project.
...
SECRET_KEY = 'django-insecure-(lqms=4fmjn2#oz-i05gjf%kg*b(ks8**+u%hpqi3+#**%3)#8'
...
ROOT_URLCONF = 'Proyecto_Munay.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS':[os.path.join(BASE_DIR, 'Proyecto_Munay/Templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Proyecto_Munay.wsgi.application'
